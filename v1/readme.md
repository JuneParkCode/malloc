...
### merge free space
** 해당 내용 아래와 같이 구현하지 않았음. **
-> free 과정에서 merge 가 이루어져야하는데, 이를 구현하지 않음. 따라서 해당 malloc 의 경우 fragmentation 문제와 함께 메모리 효율이 상당히 저하되는 문제를 안고 있다.
